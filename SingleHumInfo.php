...
$rs1=mysqli_query($con,"select CoverPic, Book_id, name, author, publisher, cost, NoPages, Pdf from HumourTb where CoverPic='$imgnm'")  or die(mysql_error());
	...
	echo "<table border='1'>";
		while($row=mysqli_fetch_array($rs1))
		{
			...
			echo "<tr><td>Cost: ".$row[5]."</td></tr>";		
			echo "<tr><td>No Of Pages: ".$row[6]."</td></tr>";	
...
?>
<form id="form1" style="margin-bottom:5%">
	<table>
    	<tr>
        	<th>Review Box: </th>
        </tr>
